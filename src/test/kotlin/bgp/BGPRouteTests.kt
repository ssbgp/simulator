...
object BGPRouteTests : Spek({
    ...
    given("route1 has higher LOCAL-PREF than route2") {
        ...
        it("returns positive value if length of the AS-PATH of route1 is shorter than route2's") {
            val route1 = BGPRoute.with(localPref = 10, asPath = pathOf(BGPNode.with(id = 1)))
            val route2 = BGPRoute.with(localPref = 5, asPath = pathOf(BGPNode.with(id = 1), BGPNode.with(id = 2)))
        ...
        it("returns positive value if length of the AS-PATH of route1 is equal than route2's") {
            val route1 = BGPRoute.with(localPref = 10, asPath = pathOf(BGPNode.with(id = 1)))
            val route2 = BGPRoute.with(localPref = 5, asPath = pathOf(BGPNode.with(id = 1)))
    ...
    given("route1 has same LOCAL-PREF as route2 and they have different AS-PATH lengths") {
        ...
        it("returns positive value if length of the AS-PATH of route1 is shorter than route2's") {
            val route1 = BGPRoute.with(localPref = 10, asPath = pathOf(BGPNode.with(id = 1)))
            val route2 = BGPRoute.with(localPref = 10, asPath = pathOf(BGPNode.with(id = 1), BGPNode.with(id = 2)))

            assertThat(bgpRouteCompare(route1, route2), greaterThan(0))
        }

        it("returns negative value if length of the AS-PATH of route1 is longer than route2's") {
            val route1 = BGPRoute.with(localPref = 10, asPath = pathOf(BGPNode.with(id = 1), BGPNode.with(id = 2)))
            val route2 = BGPRoute.with(localPref = 10, asPath = pathOf(BGPNode.with(id = 1)))
    ...
    given("routes 1 and 2 have the same LOCAL-PREF the same AS-PATH length") {
        ...
        it("returns positive value if the ID of the next-hop node of route1 is lower than route2's") {
            val route1 = BGPRoute.with(localPref = 10, asPath = pathOf(BGPNode.with(id = 1), BGPNode.with(id = 2)))
            val route2 = BGPRoute.with(localPref = 10, asPath = pathOf(BGPNode.with(id = 2), BGPNode.with(id = 3)))

            assertThat(bgpRouteCompare(route1, route2), greaterThan(0))
        }

        it("returns negative value if the ID of the next-hop node of route1 is higher than route2's") {
            val route1 = BGPRoute.with(localPref = 10, asPath = pathOf(BGPNode.with(id = 2), BGPNode.with(id = 3)))
            val route2 = BGPRoute.with(localPref = 10, asPath = pathOf(BGPNode.with(id = 1), BGPNode.with(id = 2)))
        ...
        it("returns zero if the ID of the next-hop node of route1 is equal to route2's") {
            val route1 = BGPRoute.with(localPref = 10, asPath = pathOf(BGPNode.with(id = 2), BGPNode.with(id = 1)))
            val route2 = BGPRoute.with(localPref = 10, asPath = pathOf(BGPNode.with(id = 3), BGPNode.with(id = 1)))
