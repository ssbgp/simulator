 ...
 * @author David Fialho
 *
 * The [Engine] is the starting point to run simulations. It provides the [simulate] methods,
 ...
 *
 * The [Engine] also holds the [scheduler] and [messageDelayGenerator] being used on the
 * simulations. Simulation events are scheduled using the [scheduler] specified by the [Engine].
...
object Engine {
    ...
    /**
     * Resets the engine's configurations to its defaults.
     */
    fun resetToDefaults() {
        scheduler = Scheduler()
